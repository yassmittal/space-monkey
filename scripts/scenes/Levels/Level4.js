...
function gameOver(scene, bgMusic, gameOverSound, Game) {
  ...
  scene.scene.launch("YouLooseScene", { scene: this, bgMusic: bgMusic, currentLevel: "Level4" });
}
...
function gameWon(scene, bgMusic, levelCompleteSound) {
  ...
  scene.anims.remove('dead1');
  scene.anims.remove('dead2');
  scene.scene.launch("YouWonScene", { nextLevel: "Level5", currentLevel: "Level4", bgMusic: bgMusic });
  bgMusic.pause();
