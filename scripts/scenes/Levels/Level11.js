...
function gameOver(scene, bgMusic, gameOverSound, Game) {
  ...
  scene.scene.launch("YouLooseScene", { scene: this, bgMusic: bgMusic, currentLevel: "Level11" });
}
...
function gameWon(scene, bgMusic, levelCompleteSound) {
  ...
  scene.anims.remove('dead1');
  scene.anims.remove('dead2');
  scene.scene.launch("YouWonScene", { nextLevel: "Level12", currentLevel: "Level11", bgMusic: bgMusic });
  bgMusic.pause();
